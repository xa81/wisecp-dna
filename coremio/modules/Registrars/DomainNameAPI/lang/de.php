...
return [
    ...
    'fields'            => [
        ...
        'test-mode'     => 'Test Mode',
        'WHiddenAmount' => "WhoIS-Schutzgeb\xc3\xbchr",
        'adp'           => 'Preise automatisch aktualisieren',
        'import-tld'    => 'Erweiterungen importieren',
    ],
    'desc'              => [
        'WHiddenAmount' => "<br> Fordern Sie eine Geb\xc3\xbchr f\xc3\xbcr den whois-Schutzdienst an.",
        ...
        'import-tld-1'  => 'Importieren Sie automatisch alle Erweiterungen',
        'import-tld-2'  => 'Alle in der API registrierten Domain-Endungen und Kosten werden gemeinsam importiert.',
    ],
    'tab-detail'        => 'API-Informationen',
    'tab-import'        => 'Importieren',
    'test-button'       => 'Testverbindung',
    'import-note'       => "Sie k\xc3\xb6nnen problemlos die Domain-Namen \xc3\xbcbertragen, die bereits im System des Anbieters registriert sind. Die importierten Domainnamen werden als Addon erstellt, Domainnamen, die derzeit im System registriert sind, werden gr\xc3\xbcn markiert.",
